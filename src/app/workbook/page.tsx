...
export default function WorkbookIndexPage() {
  return (
    <div className="space-y-8">
      <section className="rounded-2xl bg-white p-8 shadow-lg ring-1 ring-slate-200/60">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">Workbooks</h1>
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        {sheets.map((sheet) => (
          <Link
            ...
            prefetch={true}
            className="group block rounded-2xl bg-white p-6 shadow-md ring-1 ring-slate-200/80 transition-shadow duration-200 hover:shadow-xl active:scale-[0.99]"
          >
